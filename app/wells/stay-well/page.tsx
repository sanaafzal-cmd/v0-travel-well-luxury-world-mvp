...
function getPartnerUrl(url: string, name: string, returnPath: string = "/wells/stay-well") {
...
const partners = [
  ...
  {
    name: "Hotels.com",
    description: "Earn rewards with every stay",
    url: "https://www.hotels.com/",
    logo: "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=400&q=80",
  },
  {
    name: "Airbnb",
    description: "Unique stays and experiences",
    url: "https://www.airbnb.com/",
    logo: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=400&q=80",
  },
]

export default function StayWellPage() {
      ...
      <div className="relative h-[40vh] min-h-[300px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 lg:p-12">
          ...
          <p className="text-[#A1A1A1] font-sans text-lg max-w-xl mt-3">
            Find your perfect accommodation. From luxury hotels to unique stays, book with confidence through our partners.
          </p>
        </div>
      </div>
