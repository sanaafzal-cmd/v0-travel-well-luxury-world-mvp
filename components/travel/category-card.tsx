    ...
    >
      ...
      <div className="relative aspect-[4/3] w-full">
        ...
        <div className="absolute top-4 left-4 flex items-center gap-2">
          ...
          {option.tierTag && (
            <span className="px-2 py-0.5 rounded-full bg-[#0F0F10]/70 backdrop-blur-sm border border-[#2A2A2B] text-[10px] text-[#A1A1A1] font-sans tracking-wide">
              {option.tierTag}
            </span>
          )}
        </div>
